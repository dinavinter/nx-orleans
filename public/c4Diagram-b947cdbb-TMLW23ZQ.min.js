import { a as de, f as fe } from './chunk-G2NF7P7O.min.js';
import {
  Ga as $t,
  Ia as te,
  J as Ie,
...
import { d as Zt } from './chunk-P42HNYSU.min.js';
var ke = Zt(Ye(), 1);
var B0 = Zt(Be(), 1),
  Y0 = Zt(Ie(), 1);
var It = (function () {
  var e = function (bt, _, x, m) {
    ...
    Qt = {
      ...
      parse: function (_) {
        ...
        var Gt = D.yylloc;
        u.push(Gt);
        var Le = D.options && D.options.ranges;
            ...
            case 2:
              if (
                ...
                (Kt = this.performAction.apply(
                  wt,
                  [y, ce, Et, vt.yy, B[1], T, u].concat(Me)
                )),
                typeof Kt < 'u')
              )
                return Kt;
...
var je = It,
  ...
  Ke = function (e, t, a, o, l, i, s, r, n, h, f) {
  ...
  we = function (e, t, a, o, l, i) {
    ...
    let r = i.startsWith('data:image/png;base64') ? i : (0, ke.sanitizeUrl)(i);
    s.attr('xlink:href', r);
  },
  p0 = (e, t, a) => {
    let o = e.append('g'),
  ...
  g0 = function (e, t, a) {
    ...
    switch (
      ...
      case 'person':
      case 'external_person':
        we(n, 48, 48, t.x + t.width / 2 - 24, t.y + t.image.Y, r);
        break;
    }
...
function De(e, t, a, o, l) {
  ...
  for (let [s, r] of o.entries()) {
    ...
    p.length > 0 && Re(i, e, d, p), (t = r.alias);
    let E = l.db.getBoundarys(t);
    E.length > 0 && De(e, t, i, E, l),
      r.alias !== 'global' && Te(e, r, i),
...
var R0 = function (e, t, a, o) {
    ...
    De(n, '', h, d, o),
      ...
      T0(n, o.db.getRels(), o.db.getC4Shape, o),
      (h.data.stopx = Ft),
      (h.data.stopy = Vt);
    let p = h.data,
  ...
  ve = { drawPersonOrSystemArray: Re, drawBoundary: Te, setConf: se, draw: R0 },
  D0 = (e) => `.person {
...
`,
  ...
  I0 = {
    ...
    styles: S0,
    init: ({ c4: e, wrap: t }) => {
      ve.setConf(e), ie.setWrap(t);
    },
  };
export { I0 as diagram };
