import { b as Q } from './chunk-ICFROH4Y.min.js';
import {
  G as K,
  Ga as g,
  I as P,
...
var vt = (e, t, a, i) => {
  ...
  M = async (e, t, a, i) => {
    ...
    t.labelType === 'markdown'
      ...
      : (h = o.appendChild(R(V(U(c), b()), t.labelStyle, !1, i)));
    let y = h.getBBox(),
      f = t.padding / 2;
...
var Bt = (e, t) => {
  ...
  Et = Bt,
  w = { node: Lt, circle: St, ellipse: lt, polygon: Tt, rect: Et },
  Ct = async (e, t) => {
  ...
  rt = (e) => (e ? ' ' + e : ''),
  _ = (e, t) => `${t || 'node default'}${rt(e.classes)} ${rt(e.class)}`,
  at = async (e, t) => {
  ...
  Ut = async (e, t) => {
    ...
    if (
      ...
      t.props.borders && (q(r, t.props.borders, s, n), h.delete('borders')),
        h.forEach((y) => {
  ...
  Zt = async (e, t) => {
    ...
    if (
      ...
      t.props.borders && (q(i, t.props.borders, l, r), s.delete('borders')),
        s.forEach((n) => {
...
var Gt = (e, t) => {
  ...
  Pt = (e, t) => {
    ...
    t.classData.members.forEach((v) => {
      ...
      let N = f
          .node()
          .appendChild(R(W, L.cssStyle ? L.cssStyle : t.labelStyle, !0, !0)),
        $ = N.getBBox();
      if (H(b().flowchart.htmlLabels)) {
        let J = N.children[0],
          j = T(N);
  ...
  or = async (e, t, a) => {
    ...
    if (t.link) {
      ...
      b().securityLevel === 'sandbox'
        ...
        (l = await st[t.shape](i, t, a));
    } else (l = await st[t.shape](e, t, a)), (i = l);
    return (
...
var G = (e) => (Array.isArray(e) ? { x: e[0], y: e[1] } : e),
  ...
  ar = (e, t, a, i, l) => {
    t.arrowTypeStart && it(e, 'start', t.arrowTypeStart, a, i, l),
      t.arrowTypeEnd && it(e, 'end', t.arrowTypeEnd, a, i, l);
  },
  er = {
    arrow_cross: 'cross',
    arrow_point: 'point',
  ...
  ur = function (e, t, a, i, l, r, s) {
    ...
    h?.intersect &&
      ...
      a.toCluster &&
        ...
        (n = nt(a.points, i[a.toCluster].node)),
        (c = !0)),
      a.fromCluster &&
        (g.debug('from cluster abc88', i[a.fromCluster]),
        (n = nt(n.reverse(), i[a.fromCluster].node).reverse()),
        (c = !0));
