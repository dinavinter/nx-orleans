  ...
  var t = function (C, r, n, i) {
    ...
    ht = {
      ...
      parse: function (r) {
        ...
        var yt = S.yylloc;
        e.push(yt);
        var Wt = S.options && S.options.ranges;
...
var Ut = qt,
  ct = [],
  V = jt(),
  zt = () => ({ relations: [], states: {}, documents: {} }),
  ot = { root: zt() },
  g = ot.root,
  Y = 0,
  Pt = 0,
  ie = { LINE: 0, DOTTED_LINE: 1 },
  re = { AGGREGATION: 0, EXTENSION: 1, COMPOSITION: 2, DEPENDENCY: 3 },
  ...
  ae = () => ct,
  lt = (t, s, a) => {
    if (s.stmt === Ft) lt(t, s.state1, !0), lt(t, s.state2, !1);
    else if (
      (s.stmt === _t &&
        (s.id === '[*]'
      ...
      if (h.length > 0 && f.length > 0) {
        let y = { stmt: _t, id: vt(), type: 'divider', doc: at(f) };
        h.push(at(y)), (s.doc = h);
      }
      ...
      s.forEach((a) => {
        switch (a.stmt) {
          case _t:
            ...
            break;
          case Ft:
            Ht(a.state1, a.state2, a.description);
            break;
          case Qt:
            Xt(a.id.trim(), a.classes);
            break;
          case Zt:
  ...
  I = function (
    ...
    g.states[u] === void 0
      ...
      y &&
        ...
        (typeof y == 'string' ? [y] : y).forEach((T) => _e(u, T.trim()))),
      E &&
        (k.info('Setting state styles', u, y),
        (typeof E == 'string' ? [E] : E).forEach((T) => me(u, T.trim())));
  },
  Mt = function (t) {
    (ot = { root: zt() }), (g = ot.root), (Y = 0), (V = jt()), t || At();
  },
  G = function (t) {
    return g.states[t];
  },
...
var Ht = function (t, s, a) {
  ...
  Xt = function (t, s = '') {
    ...
    s?.split(se).forEach((h) => {
      ...
      if (h.match($t)) {
        let y = f.replace(Bt, ee).replace($t, Bt);
        a.textStyles.push(y);
      }
      a.styles.push(f);
    });
  ...
  Ee = (t) => (t && t[0] === ':' ? t.substr(1).trim() : t.trim()),
  ve = {
    getConfig: () => R().state,
    addState: I,
    clear: Mt,
