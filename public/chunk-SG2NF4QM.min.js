  ...
  var e = function (x, u, a, h) {
    ...
    ve = {
      ...
      parse: function (u) {
        ...
        var Ie = b.yylloc;
        t.push(Ie);
        var At = b.options && b.options.ranges;
            ...
            case 2:
              if (
                ...
                (Re = this.performAction.apply(
                  P,
                  [s, Qe, le, I.yy, y[1], f, t].concat(ht)
                )),
                typeof Re < 'u')
              )
                return Re;
...
var Kt = Pe,
    ...
    parseMember(i) {
      ...
      if (this.memberType === 'method') {
        ...
        if (o) {
          let A = o[1] ? o[1].trim() : '';
          if (
            (it.includes(A) && (this.visibility = A),
            (this.id = o[2].trim()),
        ...
        let l = i.length,
          o = i.substring(0, 1),
          A = i.substring(l - 1);
        it.includes(o) && (this.visibility = o),
          A.match(/[$*]/) && (r = A),
          (this.id = i.substring(
            this.visibility === '' ? 0 : 1,
            r === '' ? l : l - 1
  ...
  gt = function (e) {
    qe.debug('Adding relation: ' + JSON.stringify(e)),
      fe(e.id1),
      fe(e.id2),
  ...
  Tt = function (e, i) {
    Array.isArray(i) && (i.reverse(), i.forEach((r) => rt(e, r)));
  },
  Ft = function (e, i) {
...
`,
  Qt = Gt;
export { Kt as a, Yt as b, Qt as c };
