import { b as w } from './chunk-P42HNYSU.min.js';
var v = w((u, f) => {
  (function (c, e) {
    ...
    return function (c) {
      ...
      if (typeof c.stemmerSupport > 'u')
        throw new Error(
          'Lunr stemmer support is not present. Please include / require Lunr stemmer support before this script.'
        );
      (c.ar = function () {
        this.pipeline.reset(),
          this.pipeline.add(c.ar.trimmer, c.ar.stopWordFilter, c.ar.stemmer),
          this.searchPipeline &&
            (this.searchPipeline.reset(),
            this.searchPipeline.add(c.ar.stemmer));
      }),
        (c.ar.wordCharacters = '\u0621-\u065B\u0671\u0640'),
        (c.ar.trimmer = c.trimmerSupport.generateTrimmer(c.ar.wordCharacters)),
        c.Pipeline.registerFunction(c.ar.trimmer, 'trimmer-ar'),
        (c.ar.stemmer = (function () {
          var e = this,
            s = '';
          return (
            (e.result = !1),
            ...
            (e.stem = function () {
              ...
              for (
                ...
                r < e.execArray.length && e.result != !0;
            ...
            (e.removeStopWords = function () {
              ...
              if (r.indexOf(e.word) >= 0) return !0;
            }),
            ...
            (e.removePre432 = function () {
              ...
              if (e.word == r && e.word.length >= 5) {
                ...
                e.word = e.word.replace(o, '');
              }
              return r != e.word && (e.preRemoved = !0), !1;
            }),
            (e.patternCheck = function (r) {
              for (var l = !1, t = 0; t < r.length; t++) {
                for (var o = !0, n = 0; n < r[t].pt.length; n++) {
                  var i = r[t].pt[n].c.split(','),
                    a = !1;
                  if (
                    (i.forEach(function (d) {
                      e.word[r[t].pt[n].l] == d && (a = !0);
                    }),
                    !a)
                  ) {
                    o = !1;
                ...
                if (o == !0) {
                  if (r[t].mPt) {
                    for (var m = [], p = 0; p < r[t].mPt.length; p++)
                      r[t].mPt[p].m != null
                        ? (m[r[t].mPt[p].l] = e.word[r[t].mPt[p].m])
                        : (m[r[t].mPt[p].l] = r[t].mPt[p].c);
                    e.word = m.join('');
                  }
                  e.result = !0;
                  break;
            ...
            (e.removePre1 = function () {
              var r = e.word;
              if (e.preRemoved == !1 && e.word.length > 3) {
                var l = new RegExp(
            ...
            (e.removeSuf1 = function () {
              var r = e.word;
              if (e.sufRemoved == !1 && e.word.length > 3) {
                var l = new RegExp(
            ...
            (e.wordCheck = function () {
              for (
                var r = e.word,
                  l = [e.removeSuf432, e.removeSuf1, e.removePre1],
                  t = 0,
                  o = !1;
                e.word.length >= 7 && !e.result && t < l.length;

              )
                e.word.length == 7 && !o
                  ? (e.checkPattern73(), (o = !0))
                  : (l[t](), t++, (o = !1));
              var n = [
                e.checkPattern63,
                e.removeSuf432,
              ...
              for (t = 0; e.word.length == 6 && !e.result && t < n.length; )
                n[t](), t++;
              var i = [
                e.checkPattern53,
                e.removeSuf432,
              ...
              for (t = 0; e.word.length == 5 && !e.result && t < i.length; )
                i[t](), t++;
              var a = [
                e.checkPattern43,
                e.removeSuf1,
              ...
              for (t = 0; e.word.length == 4 && !e.result && t < a.length; )
                a[t](), t++;
              return !0;
            }),
            ...
            function (r) {
              return typeof r.update == 'function'
                ? r.update(function (l) {
                    return e.setCurrent(l), e.stem(), e.getCurrent();
                  })
                : (e.setCurrent(r), e.stem(), e.getCurrent());
            }
          );
        })()),
        c.Pipeline.registerFunction(c.ar.stemmer, 'stemmer-ar'),
        (c.ar.stopWordFilter = c.generateStopWordFilter(
        ...
        c.Pipeline.registerFunction(c.ar.stopWordFilter, 'stopWordFilter-ar');
    };
  });
});
export default v();
