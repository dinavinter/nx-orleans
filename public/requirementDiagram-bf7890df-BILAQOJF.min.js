import { a as ve } from './chunk-ULAEXCMJ.min.js';
import { A as Ae } from './chunk-GT3P3F7J.min.js';
import {
  G as xe,
  Ga as he,
  J as Ge,
...
import { d as ce } from './chunk-P42HNYSU.min.js';
var wt = ce(We(), 1),
  $t = ce(Ke(), 1),
  Vt = ce(Ge(), 1);
var pe = (function () {
...
var ze = pe,
  ...
  Xe = { LOW_RISK: 'Low', MED_RISK: 'Medium', HIGH_RISK: 'High' },
  Je = {
  ...
  pt = {
    ...
    addElement: at,
    getElements: lt,
    setNewElementType: ot,
    setNewElementDocRef: ct,
    addRelationship: ht,
    getRelationships: ut,
    clear: dt,
  },
...
`,
  ...
  Fe = { ReqMarkers: fe, insertLineEndings: _t },
  y = {},
  Ce = 0,
  Me = (e, t) =>
    e
  ...
  kt = (e, t, l, c) => {
    ...
    Fe.insertLineEndings(h, y);
    let o = new Ae({ multigraph: !1, compound: !1, directed: !0 })
        .setGraph({
    ...
    let T = y.rect_padding,
      ...
      v = N.width + T * 2,
      k = N.height + T * 2;
    we(h, k, v, y.useMaxWidth),
      h.attr('viewBox', `${N.x - T} ${N.y - T} ${v} ${k}`);
  },
  St = { draw: kt },
  qt = { parser: ze, db: pt, renderer: St, styles: yt };
