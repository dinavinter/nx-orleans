      ...
      parse: function (i) {
        ...
        function z() {
          ...
          return (
            (M = d.pop() || k.lex() || A),
            typeof M != 'number' &&
              (M instanceof Array && ((d = M), (M = d.pop())),
              (M = r.symbols_[M] || M)),
            M
          );
        }
        for (var b, L, E, Z, R = {}, j, N, tt, G; ; ) {
          if (
            ((L = c[c.length - 1]),
...
var It = X,
  ...
  ut = () => at,
  pt = function () {
    (Y.length = 0), (q.length = 0), (F = ''), (V.length = 0), rt();
  },
  yt = function (n) {
    (F = n), Y.push(n);
  },
  ...
  xt = function (n) {
    V.find((e) => e.id === dt - 1).events.push(n);
  },
  _t = function (n) {
...
var Ft = function (n, t, e, a) {
  ...
  Wt = function (n, t, e) {
    n
      ...
      .attr(
        'd',
        `M0 ${t.height - 5} v${-t.height + 2 * 5} q0,-5 5,-5 h${
          t.width - 2 * 5
  ...
  Bt = function (n, t, e, a) {
    ...
    r.forEach(function (S) {
      let v = {
        ...
        T = H.getVirtualNodeHeight(m, v, o);
      w.debug('sectionHeight before draw', T), (c = Math.max(c, T + 20));
    });
    let C = 0,
      A = 0;
    ...
    for (let [S, v] of g.entries()) {
      let T = {
        ...
        P = H.getVirtualNodeHeight(m, T, o);
    ...
    w.debug('maxSectionHeight before draw', c),
      ...
      r && r.length > 0
        ? r.forEach((S) => {
            ...
            w.debug('sectionNode', T);
            let P = m.append('g'),
              z = H.drawNode(P, T, I, o);
            w.debug('sectionNode output', z),
              P.attr('transform', `translate(${$}, ${l})`),
              (x += c + 50),
              v.length > 0 && ht(m, v, I, $, x, d, o, C, A, c, !1),
              ($ += 200 * Math.max(v.length, 1)),
              (x = l),
              I++;
          })
        : ((W = !1), ht(m, g, I, $, x, d, o, C, A, c, !0));
  ...
  ht = function (n, t, e, a, s, h, o, p, y, f, _) {
    var m;
    for (let g of t) {
      let i = {
        descr: g.task,
  ...
  Gt = (n) => {
    ...
    for (let e = 0; e < n.THEME_COLOR_LIMIT; e++)
      (n['lineColor' + e] = n['lineColor' + e] || n['cScaleInv' + e]),
        et(n['lineColor' + e])
          ? (n['lineColor' + e] = nt(n['lineColor' + e], 20))
          : (n['lineColor' + e] = st(n['lineColor' + e], 20));
    for (let e = 0; e < n.THEME_COLOR_LIMIT; e++) {
      let a = '' + (17 - 3 * e);
      t += `
    .section-${e - 1} rect, .section-${e - 1} path, .section-${
        e - 1
      } circle, .section-${e - 1} path  {
      fill: ${n['cScale' + e]};
    }
    .section-${e - 1} text {
...
`,
  Ut = qt,
  te = { db: $t, renderer: jt, parser: It, styles: Ut };
