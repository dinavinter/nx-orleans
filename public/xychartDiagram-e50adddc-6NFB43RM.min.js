import { a as Et } from './chunk-ICFROH4Y.min.js';
import {
  $a as G,
  G as lt,
  Ga as ct,
  ...
  var e = function (M, o, l, c) {
    ...
    tt = {
      ...
      parse: function (o) {
        ...
        var st = A.yylloc;
        a.push(st);
        var ni = A.options && A.options.ranges;
...
var Q = class {
  ...
  K = class {
    ...
    recalculateOuterPaddingToDrawBar() {
      Ht * this.getTickDistance() > this.outerPadding * 2 &&
        (this.outerPadding = Math.floor((Ht * this.getTickDistance()) / 2)),
        this.recalculateScale();
    }
    ...
    getDrawableElementsForLeftAxis() {
      ...
      if (this.showAxisLine) {
        ...
        t.push({
          ...
          data: [
            {
              path: `M ${i},${this.boundingRect.y} L ${i},${
      ...
      if (
        ...
        t.push({
          ...
          data: this.getTickValues().map((s) => ({
            path: `M ${i},${this.getScaleValue(s)} L ${
              i - this.axisConfig.tickLength
            },${this.getScaleValue(s)}`,
    ...
    getDrawableElementsForBottomAxis() {
      ...
      if (this.showAxisLine) {
        ...
        t.push({
          ...
          data: [
            {
              path: `M ${this.boundingRect.x},${i} L ${
      ...
      if (
        ...
        t.push({
          ...
          data: this.getTickValues().map((s) => ({
            path: `M ${this.getScaleValue(s)},${i} L ${this.getScaleValue(s)},${
              i + this.axisConfig.tickLength
            }`,
            strokeFill: this.axisThemeConfig.tickColor,
            strokeWidth: this.axisConfig.tickWidth,
    ...
    getDrawableElementsForTopAxis() {
      ...
      if (
        ...
        t.push({
          ...
          data: this.getTickValues().map((s) => ({
            path: `M ${this.getScaleValue(s)},${
              i +
              this.boundingRect.height -
              (this.showAxisLine ? this.axisConfig.axisLineWidth : 0)
            } L ${this.getScaleValue(s)},${
              i +
              this.boundingRect.height -
...
var At = class {
    ...
    calculateVerticalSpace() {
      ...
      (t -= f.width),
        ...
        this.chartData.plots.some((y) => Yt(y)) &&
    ...
    calculateHorizonatalSpace() {
      ...
      (t -= y.width),
        ...
        this.chartData.plots.some((L) => Yt(L)) &&
          this.componentStore.xAxis.recalculateOuterPaddingToDrawBar();
    }
    calculateSpace() {
...
function Qt() {
  let e = G();
  return ut(It.xyChart, e.xyChart);
}
function Kt() {
  return {
...
function Jt(e) {
  ...
  if (!Z) {
    ...
    Zt(Math.min(i, 1), Math.max(s, e.length));
  }
  if (
    (_t || mi(e),
    qt(p.xAxis) && (t = p.xAxis.categories.map((i, s) => [i, e[s]])),
    N(p.xAxis))
  ) {
    let i = p.xAxis.min,
      s = p.xAxis.max,
...
function bi(e, t) {
  let i = Jt(t);
  p.plots.push({ type: 'line', strokeFill: ti(X), strokeWidth: 2, data: i }),
    X++;
}
function Ai(e, t) {
  let i = Jt(t);
  p.plots.push({ type: 'bar', fill: ti(X), data: i }), X++;
}
function wi() {
  if (p.plots.length === 0)
    throw Error('No Plot to render, please provide a plot with some data');
  return (p.title = gt()), wt.build(Y, p, H, jt);
}
function Si() {
  return H;
}
...
var ki = function () {
  ...
  Ci = {
    ...
    setOrientation: xi,
    setXAxisTitle: pi,
    setXAxisRangeData: Zt,
    setXAxisBand: di,
    setYAxisTitle: fi,
    setYAxisRangeData: yi,
    setLineData: bi,
    setBarData: Ai,
    setTmpSVGG: gi,
...
` + e
  ...
  Ti = { draw: Ri },
  Mi = { parser: li, db: Ci, renderer: Ti };
export { Mi as diagram };
//# sourceMappingURL=xychartDiagram-e50adddc-6NFB43RM.min.js.map
